...
<script>
// Trip countdown (Eastern Time, calendar date math)
(function() {{
  function easternNow() {{
  ...
  function update() {{
    ...
    var tripStartDate = new Date(2026, 2, 11);
    var tripEndDate = new Date(2026, 2, 22);
    ...
    }} else if (today < tripStartDate || (today.getTime() === tripStartDate.getTime() && now.getHours() < 6)) {{
      var diff = new Date(2026, 2, 11, 0, 0, 0) - now;
      var hours = Math.max(1, Math.ceil(diff / 3600000));
